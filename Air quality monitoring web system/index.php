...
<body class="page-index">
  ...
  <header id="header" class="header d-flex align-items-center fixed-top">
    <div class="container-fluid container-xl d-flex align-items-center justify-content-between">
       ...
       <a href="index.php" class="logo d-flex align-items-center"> 
        <img src="assets/img/logo.png" alt="" class="avatar rounded-circle"><h1 class="d-flex align-items-center">DIT AQM Center</h1>
      </a>
      ...
      <nav id="navbar" class="navbar">
          ...
          <a href="report.php"><span>reports</span></a>
          <a href="status.php">Daily Audit</a>
		  
		   <a href="https://aqicn.org/map/world">Pollution Maps</a>
          <a href="contact.php">Contact</a>
          <a href="form.php">Report Extreme Pollution</a>
  ...
  <section id="hero" class="hero d-flex align-items-center">
    <div class="container">
      <div class="row">
        <div class="col-xl-4">
          <blockquote>
            <h4 data-aos="fade-up">Empowering communities through data-driven insights for Pollution, healthier air and research."</h4>
          </blockquote>
          <div class="d-flex" data-aos="fade-up" data-aos-delay="100">
            <a href="report.php" class="btn-get-started">Check Daily AQHI Status</a>
            <a href="report.php" class="btn-watch-video d-flex align-items-center"><i class="bi-arrow-down-short"></i><span>Here</span></a>
          </div>
        </div>
      </div>
    </div>
  ...
  <footer id="footer" class="footer">
    ...
    <div class="footer-legal">
      <div class="container">
        <div class="copyright">
          &copy; <?php echo date('Y'); ?> Copyright <strong>DIT Environmental monitoring department.</strong> All Rights Reserved</p> 
        </div>
        <div class="credits"> 
